      ...
      //    printf(" %d %c\n" , j, appToRun[j]);
       ...
       int len = strlen(cmd_to_run);
        ...
        {     
           ...
           { 
          // child process 
            if(strcmp(appToRun,"mypwd") == 0 || strcmp(appToRun, "mymkdir") == 0 || strcmp(appToRun, "myls") == 0 || strcmp(appToRun, "mymv") == 0 || strcmp(appToRun , "myps") == 0 || strcmp(appToRun,"mytail") == 0 || strcmp(appToRun, "myrm") == 0 || strcmp(appToRun , "mygrep") == 0)
            {   
